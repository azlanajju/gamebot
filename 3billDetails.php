...
// Fetch all data from the historyUsage table
$sql = "SELECT * FROM historyUsage";
$result = mysqli_query($conn, $sql);

// Check if there are any rows returned
if (mysqli_num_rows($result) > 0) {
  // Begin building the table
  $bills = '<table class="table">
    <thead>
    <tr>
    <th scope="col">#</th>
  ...
  $bills = "No data found in historyUsage table.";
}

// Close the connection
mysqli_close($conn);

// Echo the bills variable
?>
