...
$sql = "SELECT * FROM historyUsage ORDER BY ID DESC ";
...
if (mysqli_num_rows($result) > 0) {
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    <td>' . $row['date'] . '</td>
        <td>' . $row['name'] . '</td>
        <td>' . date('H:i:s', strtotime($row['UpdationDate'])) . '</td>
        <td>' . $row['Fees'] . '</td>
        <th scope="col"><a class="btn btn-dark" href="./3viewBill.php?b_id=' . $row['ID'] .'">View</a></th>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Cafe</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="./4cafeItems.php" class="">
